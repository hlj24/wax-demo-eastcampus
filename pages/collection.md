...
## By Location
{% include collection_gallery.html facet_by='location' collection='buildings' %}

## By Building Type

### Dorms
{% include collection_gallery.html facet_by='type' only='dorm' collection='buildings' %}
### Academics
{% include collection_gallery.html facet_by='type' only='academics' collection='buildings' %}
### Other
{% include collection_gallery.html facet_by='type' only='gym,house,pavilion' collection='buildings' %}